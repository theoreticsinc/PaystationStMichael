...
<!-- /navigation -->
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <h1><button id="sbutton" name="sbutton"><i class="fa fa-calendar"> </i></button> Entrance Transaction Report</h1>
          ...
          <table class="table table-border">
            <tr>
              <td><b>ENTRANCE TRANSACTIONS</b></td>
            </tr>
            <tr>
              <td><b>Cashier Code</b></td>
              <td><b>Cashier<br> Name</b></td>
              <td><b>Entrance<br> ID</b></td>
            ...
            <?php foreach ($cash as $key => $value):?>
             <tr>
              <td><?php echo $value->CashierID?></td>
        ...
        <tr>
          ...
          <td><?php 
                $from = filter($_GET['from']);//POST from date
                $until = filter($_GET['until']);//POST from Date
                $query = "SELECT COUNT(TimeIN) as total FROM carpark.entrance WHERE DATE(TimeIN) BETWEEN '$from' AND '$until'";
                $trans = single_inner($query);//query for getting the results
                $total = 0;
          ...
          <div class="btn">
            <form action="" method="post">
                  <button type="submit" id="btnExport"
                    name='export_fren' value="Export to Excel"
