...
<!-- /navigation -->
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          Exit Transactions Per Terminal Report</h1>
          ...
          <td style="padding: 25px">
          <h3>Time Filter</h3>
          From: <input type="Time" id="timefrom" name="timefrom" style="width: 200px"><br>
          Until : <input type="Time" id="timeuntil" name="timeuntil" style="width: 200px"></td>
          ...
          if(isset($_GET['searchbtn1'])){
            ...
            $query = "SELECT * FROM carpark.exit_trans WHERE DATE(DateTimeOUT) BETWEEN '$from $timefrom' AND '$until $timeuntil' AND ExitID = '".$sterminal."' GROUP BY ExitID, DateTimeOUT ORDER BY ExitID, DateTimeOUT DESC";
            //echo $query;
            $_SESSION['from'] = $from;
            $_SESSION['until'] = $until;
            $_SESSION['timefrom'] = $timefrom;
            $_SESSION['timeuntil'] = $timeuntil;
            $_SESSION['sterminal'] = $sterminal;
        ...
        <tr>
          <td><b>Volume:</td></td>
          <td><?php 
                $query = "SELECT COUNT(DateTimeOUT) as total, SUM(Amount) as amount FROM carpark.exit_trans WHERE DATE(DateTimeOUT) BETWEEN '$from $timefrom' AND '$until $timeuntil' AND ExitID = '".$sterminal."'";
          ...
          <div class="btn">
            <form action="" method="post">
                  <button type="submit" id="btnExport"
                    name='export_frept' value="Export to Excel"
