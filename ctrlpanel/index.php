  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse in">
      <div class="panel-body">
        <!-- start components-->
          <?php
if(isset($_SESSION['Username']) && $_SESSION['Username'] == 'admin' && $_SESSION['password'] == 'user1') {
      
echo '
              <div class="row">
                <div class="col-md-3">
                  <a href="rpt_sales.php" target="sales_rpt" 
                  style="font-size:14px;"><img src="dist/img/sales.png" align="left" width="50" height="50"><br>Sales Report Per Terminal</a>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <a href="rpt_final_exit_perterminal.php" target="exit_rpt_perterminal" 
                  style="font-size:14px;"><img src="dist/img/carparktrans.png" align="left" width="50" height="50"><br>Daily Exit Transaction Per Terminal</a>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
