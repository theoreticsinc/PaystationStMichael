...
<!-- /navigation -->
        ...
        ?>
          ...
          <table id="CA_Table" class="table table-border">
            ...
            <?php                
              ...
              <?php 
                 $busAmt = $row["busAmount"] + $busAmt;
                 $carsAmt = $row["carsAmount"] + $carsAmt;
                 ...
                 $seniorAmt = $row["seniorAmount"] + $seniorAmt;
                 $pwdAmt = $row["pwdAmount"] + $pwdAmt;
                 $truckAmt = $row["trucksAmount"] + $truckAmt;
                 
                 $busCnt = $row["busCount"] + $busCnt;
                 $carsCnt = $row["carsCount"] + $carsCnt;
                 ...
                 $seniorCnt = $row["seniorCount"] + $seniorCnt;
 ...
 <table class="table table-border">
            ...
            <tr>
              <td>Bus</td>
              <td><?php echo $busCnt;?></td>
              <td><?php echo $busAmt;?></td>
                            
            </tr>
            <tr>
              <td>Cars</td>
              <td><?php echo $carsCnt;?></td>
              <td><?php echo $carsAmt;?></td>
           ...
           <tr>
              ...
              <td><?php echo $seniorCnt;?></td>
              <td><?php echo $seniorAmt;?></td>
           ...
           <tr>
              <td>Trucks</td>
              <td><?php echo $truckCnt;?></td>
              <td><?php echo $truckAmt;?></td>
