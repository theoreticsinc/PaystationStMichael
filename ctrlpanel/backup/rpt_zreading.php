        ...
        <section class="content">
          ...
          <table class="table table-border">
            ...
            <td>REVENUE</td>
              ...
              ?>
              <?php
               $query = "SELECT x.ParkerType, SUM(Amount) As Revenue FROM carpark.exit_trans x INNER JOIN parkertypes.main p ON x.ParkerType=p.ParkerType WHERE '".$p."'=x.ParkerType AND DATE(DateTimeIN) BETWEEN '$from' AND '$until' GROUP BY ParkerType";
              //echo $query;
          ...
          <tr>
            <td>VOLUME</td>
              ...
              ?>
              <?php
               $query = "SELECT x.ParkerType, COUNT(x.ParkerType) As Volume FROM carpark.exit_trans x INNER JOIN parkertypes.main p ON x.ParkerType=p.ParkerType WHERE '".$p."'=x.ParkerType AND DATE(DateTimeIN) BETWEEN '$from' AND '$until' GROUP BY ParkerType";
              //echo $query;
              $rev = getdata_inner_join($query); //query for getting the results
              //echo $rev;
              if (is_array($rev)) {
