        ...
        <section class="content">
          ...
          <tr>
              ...
              <?php foreach ($ext19 as $key => $value):?>
                <?php if ($value->ParkerType == 'R'):?>
                    <td>RETAIL</td>
                    <td colspan="24"></td>
                  <tr>
                    <td><?php echo $value->DateTimeOUT?></td>
                    <td><?php if ($value->hour == '5') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '6') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '7') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '8') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '9') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '10') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '11') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '12') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '13') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '14') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '15') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '16') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '17') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '18') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '19') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '20') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '21') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '22') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '23') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '24') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '1') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '2') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '3') : echo $value->count;endif;?></td>
                    <td><?php if ($value->hour == '4') : echo $value->count;endif;?></td>
                  </tr>
                  <?php endif;?>
                  <?php if ($value->ParkerType == 'V'):?>
                    <td>VIP</td>
                    <td colspan="24"></td>
                  <tr>
                    <td><?php echo $value->DateTimeOUT?></td>
