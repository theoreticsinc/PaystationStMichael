...
<!-- /navigation -->
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <h1><button id="sbutton" name="sbutton"><i class="fa fa-calendar"> </i></button> Stay In Report</h1>
          ...
          if(isset($_GET['searchbtn1'])){
            ...
            $sql1 = "SELECT * FROM crdplt.main WHERE DATE(datetimeIN) BETWEEN '$from' AND '$until' ";
            $stayin = getdata_inner_join($sql1);
          ...
          <table class="table table-border">
            ...
            <tr>
              ...
              <td><b>Date /<br> Time IN</b></td>
            </tr>
            <tr>
            <?php if(!empty($stayin)):?>
            <?php foreach ($stayin as $key => $value):?>
             <tr>
              <td><?php echo $value->areaID?></td>
              <td><?php echo $value->entranceID?></td>
              <td><?php echo $value->cardNumber?></td>
              <td><?php echo $value->plateNumber?></td>
              <td><?php echo $value->trtype?></td>
