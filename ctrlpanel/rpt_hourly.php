...
<!-- /navigation -->
    <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <h1><button id="sbutton" name="sbutton"><i class="fa fa-calendar"> </i></button> Hourly Report</h1>
          ...
          if(isset($_GET['searchbtn1'])){
            echo ('<script>
              $( "#sbutton"d ).on( "click", function( event ) {
            ...
            $query = "SELECT HoursParked, Count(HoursParked) AS Count, ParkerType, SUM(Amount) AS Amount FROM carpark.exit_trans WHERE DATE(DateTimeOUT) BETWEEN '$from' AND '$until' GROUP BY HoursParked, ParkerType ORDER BY HoursParked, ParkerType DESC";
          ...
          <table class="table table-border">
            <tr>
              <td><b>HOURLY TRANSACTIONS</b></td>
            </tr>
            <tr>
              <td><b>Num of Hours<br>Parked</b></td>
              <td><b>Num of Parkers</b></td>
              <td><b>Type of Parkers<br></b></td>
              <td><b>Sub Total<br></b></td>
